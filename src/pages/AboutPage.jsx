  ...
  return (
    <main className="pt-24 px-6 pb-20 max-w-4xl mx-auto text-on-surface">
      ...
      <img
        ...
        alt="Neura Imagen 2"
        className="rounded-2xl w-full mb-10 shadow-lg border border-outline-variant animate-breathe"
      />
      ...
      <img
        ...
        alt="Neura Imagen 3"
        className="rounded-2xl w-full mt-10 shadow-lg border border-outline-variant animate-float-soft animate-glow-soft"
      />
    </main>
  );
}
